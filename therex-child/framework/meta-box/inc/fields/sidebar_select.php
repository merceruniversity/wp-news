...
if ( ! class_exists( 'RWMB_Sidebar_Select_Field' ) )
{
	class RWMB_Sidebar_Select_Field extends RWMB_Field
	{
		...
		{
			$html = '';
            $html .=  '<option value="global"'.selected( in_array( 'global', (array) $meta ), true, false ).'>'.__( "Global Setting", "bkninja" ).'</option>';
            $html .=  '<option value="disable"'.selected( in_array( 'disable', (array) $meta ), true, false ).'>'.__( "Disable Sidebar", "bkninja" ).'</option>';
