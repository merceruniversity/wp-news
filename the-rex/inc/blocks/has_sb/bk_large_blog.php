<?php
class bk_large_blog extends bk_section_parent  {
...
///////////////////////
        ...
        $module_cfg = bk_get_cfg::configs($cfg_ops['has_sb']['bk_large_blog'], $page_info);    //get block config
...
// locallize ajax vars 
        ...
        $block_str .= '<div id="'.$uid.'" class="bkmodule module-large-blog module-blog">';
        ...
        if($bk_ajax_button !== 'disable') {
            $block_str .= '<div class="blog-ajax loadmore large-blog">';
    ...
    static function render_modules ($the_query, $bk_post_icon){
        $render_modules = '';
        $bk_contentout = new bk_contentout6;
        ...
        if ( $the_query->have_posts() ) :            
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                $render_modules .= '<div class="content_out clearfix"><div class="post-wrapper-inner">';
