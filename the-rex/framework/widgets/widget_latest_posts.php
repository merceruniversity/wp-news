...
class bk_latest_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_latest_posts', 'description' => esc_html__('[Sidebar widget] Displays latest posts in sidebar.', 'the-rex') );

		/* Create the widget. */
		parent::__construct( 'bk_latest_posts', esc_html__('BK-Ninja: Widget Latest Posts', 'the-rex'), $widget_ops);
	}
	...
	function form( $instance ) {
		$defaults = array('title' => 'Latest Posts','entries_display' => 5, 'offset_post' => 0, 'category' => 'all');
