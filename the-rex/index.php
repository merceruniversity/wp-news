...
<div id="body-wrapper" class="wp-page">
    <div class="module-title bkwrapper container">
        <div class="main-title">
            <h2 class="heading"><?php esc_html_e( 'Latest Articles', 'the-rex');?></h2> 
        </div>
    </div>
    <div class="bkwrapper container">		
        <div class="row">			
            <div class="bk-blog-content bkpage-content <?php if ((!($bk_layout == 'masonry-nosb')) && (!($bk_layout == 'square-grid-3'))): echo 'col-md-8 has-sb'; else: echo 'col-md-12 fullwidth';  endif;?>">
                <div class="row">
            ...
            <?php
                if ((!($bk_layout == 'masonry-nosb')) && (!($bk_layout == 'square-grid-3'))) {?>
                    <div class="sidebar col-md-4">
                        <div class="sidebar-wrap <?php if($bk_option['author-stick-sidebar'] == 'enable') echo 'stick';?>" id="bk-index-sidebar">
